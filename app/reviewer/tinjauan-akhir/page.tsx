      ...
      <Card className="gap-0 overflow-hidden p-0">
        <CardContent className="p-4">
          <TableToolbar
            ...
            searchPlaceholder="Cari ID, SO, subjek, teknisi..."
            filters={[
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="bg-muted/50 px-6 py-3">Unit</TableHead>
            ...
            <TableBody>
              {paginatedTickets.map((ticket) => (
                <TableRow key={ticket.id}>
                  ...
                  <TableCell className="px-6 py-3">
                    <span className="text-sm">{ticket.assignedUnit ?? 'Teknis BRT'}</span>
                  </TableCell>
                  <TableCell className="px-6 py-3">
