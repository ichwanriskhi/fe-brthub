...
export default function HandlerHistoryPage() {
  ...
  const closedTickets = MOCK_TICKETS.filter((t) => {
    const isTargetStatus = t.status === 'CLOSED';
      ...
      <Card className="gap-0 overflow-hidden p-0">
        ...
        {paginatedTickets.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-2 border-t py-12 text-center">
            ...
            <p className="text-sm font-medium">Tidak ada riwayat tiket</p>
            <p className="text-xs text-muted-foreground">Belum ada tiket yang selesai.</p>
          </div>
        ) : (
